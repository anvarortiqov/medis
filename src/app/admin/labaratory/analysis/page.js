...
const Analysis = () => {
    ...
    const invoice = invoices.map((invoice, index) => (
        <TableRow key={invoice.invoice} className="text-text_color text-[15px]">
            ...
            <TableCell>
                <Link href="#">{invoice.servicetype}</Link>
            </TableCell>
            <TableCell>
                <Link href="#">{invoice.fish}</Link>
            </TableCell>
            <TableCell>{invoice.sana} </TableCell>
            <TableCell>
        ...
        <div className="w-full m-auto flex flex-col justify-between">
            <header>
                <div className="grid grid-cols-3 w-full gap-5 py-3 ">
                    <Input className="bg-white box-shadow" type="search" placeholder="Qidirish..."/>
                    <div></div>
                    <Select>
                        <SelectTrigger className="bg-white box-shadow">
                            <SelectValue placeholder="Analiz turini tanlang"/>
                        </SelectTrigger>
                        <SelectContent>
                            <SelectGroup>
                                <SelectLabel>Analiz Turi</SelectLabel>
            ...
            <main className="employee-main ">
                <Table>
                    <TableCaption>A list of Analysis.</TableCaption>
                    <TableHeader>
                        <TableRow className="text-[#737791] text-[16px] font-medium">
                            <TableHead className="w-[70px]">№</TableHead>
                            <TableHead>Analiz Turi</TableHead>
